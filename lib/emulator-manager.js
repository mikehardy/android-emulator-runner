    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!fs.existsSync(avdPath) || forceAvdCreation) {
                ...
                console.log('AVD list: ' + (yield exec.getExecOutput(`sh -c "avdmanager list avd"`)).stdout.trim());
            ...
            console.log('AVD list: ' + (yield exec.getExecOutput(`sh -c "avdmanager list avd"`)).stdout.trim());
            console.log('emulator list: ' + (yield exec.getExecOutput(`sh -c "${process.env.ANDROID_HOME}/emulator/emulator -list-avds"`)).stdout.trim());
            if (cores) {
