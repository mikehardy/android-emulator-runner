    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!fs.existsSync(avdPath) || forceAvdCreation) {
                ...
                yield exec.exec(`sh -c \\"echo no | avdmanager create avd --force -n "${avdName}" --path "${avdPath}" --abi '${target}/${arch}' --package 'system-images;android-${apiLevel};${target};${arch}' ${profileOption} ${sdcardPathOrSizeOption}"`);
            }
            if (cores) {
